var knife,gameOver,smileyBallsGroup1,smileyBallsGroup2,smileyBallsGroup3,
...
orangesGroup3,orangesGroup4,gameOver,restart12,play,play_button;
...
function setup() 
{
  ...
  restart12.setCollider("circle",0,-2,160)
  restart12.debug = false;
  ...
  if(gameState == START)
    {
      ...
      if(knife.isTouching(play_button) || mousePressedOver(play_button))
        {
          gameState = PLAY;
}
    }
